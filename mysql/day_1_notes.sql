...
-- Dump completed on 2022-07-13 14:53:36
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2022-07-12 16:13:45',NULL),('diagnostics.include_raw','OFF','2022-07-12 16:13:45',NULL),('ps_thread_trx_info.max_length','65535','2022-07-12 16:13:45',NULL),('statement_performance_analyzer.limit','100','2022-07-12 16:13:45',NULL),('statement_performance_analyzer.view',NULL,'2022-07-12 16:13:45',NULL),('statement_truncate_len','64','2022-07-12 16:13:45',NULL);
...
-- Dump completed on 2022-07-13 14:53:38
CREATE DATABASE  IF NOT EXISTS `likes_db` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `likes_db`;
-- MySQL dump 10.13  Distrib 8.0.22, for macos10.15 (x86_64)
--
-- Host: localhost    Database: likes_db
-- ------------------------------------------------------
-- Server version	8.0.23
...
CREATE TABLE `comments` (
  `comments` int NOT NULL AUTO_INCREMENT,
  `id` varchar(255) DEFAULT NULL,
  `content` varchar(255) DEFAULT NULL,
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `user_id` int NOT NULL,
  `post_post` int NOT NULL,
  PRIMARY KEY (`comments`),
  KEY `fk_table3_users1_idx` (`user_id`),
  KEY `fk_comments_posts1_idx` (`post_post`),
  CONSTRAINT `fk_comments_posts1` FOREIGN KEY (`post_post`) REFERENCES `posts` (`post`),
  CONSTRAINT `fk_table3_users1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `likes` (
  ...
  CONSTRAINT `fk_likes_posts1` FOREIGN KEY (`posts_id`) REFERENCES `posts` (`post`),
...
CREATE TABLE `posts` (
  ...
  PRIMARY KEY (`post`),
  KEY `fk_table2_users_idx` (`user_id`),
  CONSTRAINT `fk_table2_users` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-07-13 14:53:38
CREATE DATABASE  IF NOT EXISTS `lead_gen_business` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `billing` (
  ...
  CONSTRAINT `fk_billing_clients1` FOREIGN KEY (`clients_id`) REFERENCES `clients` (`id`)
...
CREATE TABLE `leads` (
  ...
  CONSTRAINT `fk_leads_sites1` FOREIGN KEY (`sites_id`) REFERENCES `sites` (`id`)
...
CREATE TABLE `sites` (
  ...
  CONSTRAINT `fk_sites_clients` FOREIGN KEY (`clients_id`) REFERENCES `clients` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
